...
,[start_date]
,[end_date]
,[pricing_sequence] FROM Backups.bkup.[diners_billing_db_dbo_tblPriceZones_20230202] ---back up of the pricing table taken from step 2 --20190502_AA changes every month
