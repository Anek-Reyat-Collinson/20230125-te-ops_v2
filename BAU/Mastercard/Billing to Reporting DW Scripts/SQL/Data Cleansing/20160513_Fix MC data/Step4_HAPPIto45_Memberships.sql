...
SET @Startbillingmonth = '2015-01-01'
SET @Endbillingmonth = '2015-06-01'
...
set @NumRecs = (select count(*) from mastercard_db.dbo.tblLKMemberships WHERE [report_month] BETWEEN @Startbillingmonth AND @Endbillingmonth)
select @NumRecs
IF @NumRecs > 0
	BEGIN
		--PRINT 'Data Exists for this month in Target: mastercard_db.dbo.tblLKMemberships'
		DELETE from mastercard_db.dbo.tblLKMemberships WHERE [report_month] BETWEEN @Startbillingmonth AND @Endbillingmonth
	END
